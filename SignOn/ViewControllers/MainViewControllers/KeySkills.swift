...
class KeySkills: UIViewController ,searchData {
    ...
    @IBAction func btnKeySkillsTapped(_ sender: Any) {
...
//                    }
//                    
//                    if let keywordsIDArray = responseJASON["Skills"].arrayObject as? NSArray{
//                        for item in keywordsIDArray{
//                            if let itemDict = item as? NSDictionary{
//                                
//                                if let name = itemDict.value(forKey: "Name") as? String{
//                                    self.keywordArray.add(name)
//                                }
//                                
//                                
//                            }
...
//            let passDict = ["Skills":self.keywordArray,
//                            "SkillIds":self.keywordsIDArray,
//                            "Id":userID] as [String: AnyObject]
    ...
    func validationSetup()->Void{
        ...
        var message = ""
        if !validation.validateBlankField(txtSkills.text!){
